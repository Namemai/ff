                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            try:
                                                random.choice(team1).kickoutFromGroup(op.param1,[target])
                                                random.choice(team1).inviteIntoGroup(op.param1,Bots)
                                                k7.acceptGroupInvitation(op.param1)
                                                random.choice(team1).cancelGroupInvitation(op.param1,[target])
                                            except:
                                                random.choice(team1).kickoutFromGroup(op.param1,[target])
                                                random.choice(team1).inviteIntoGroup(op.param1,Bots)
                                                k7.acceptGroupInvitation(op.param1)
