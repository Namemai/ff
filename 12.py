...
call = cl
oepoll = OEPoll(cl)
team1=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team2=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team3=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team4=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team5=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team6=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team7=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team8=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team9=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team10=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team11=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team12=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
team13=[ka,kb,kc,kd,ke,kf,k7,k8,k9,k10,k11,k12]
            ...
            if op.param1 in protectqr:
                if op.param2 in TEAM or op.param2 in DZbot["Bots"] or op.param2 in DZbot["admin"]:pass
                    ...
                    if Z.preventedJoinByTicket == False:
                        ...
                        random.choice(team2).updateGroup(Z)
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            ...
                                                            try:
                                                                ...
                                                                try:
                                                                    random.choice(team13).kickoutFromGroup(op.param1,[op.param2])
                                                                    random.choice(team13).inviteIntoGroup(op.param1,Bots)
                                                                    k11.acceptGroupInvitation(op.param1)
                                                                    random.choice(team13).cancelGroupInvitation(op.param1,[op.param2])
                                                                except:
                                                                    random.choice(team13).kickoutFromGroup(op.param1,[op.param2])
                                                                    random.choice(team13).inviteIntoGroup(op.param1,Bots)
                                                                    k11.acceptGroupInvitation(op.param1)
                    ...
                    if op.param2 not in TEAM:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    X = random.choice(team1).getGroup(op.param1)
                                    X.preventedJoinByTicket = False
                                    random.choice(team1).updateGroup(X)
               ...
               if msg.contentType == 1:
                 if msg._from in ownerbot:
                   if settings["changegambar"] == True:
                     ...
                     k8.updateProfilePicture(path8)
                     k8.sendMessage(msg.to, "Succes Ubab pic 8")
                     k9.updateProfilePicture(path9)
                     k9.sendMessage(msg.to, "Succes Ubah pic 9")
                     k10.updateProfilePicture(path10)
                     k10.sendMessage(msg.to, "Succes Ubah pic 10")
                     k11.updateProfilePicture(path11)
                     k11.sendMessage(msg.to, "Succes Ubah pic 11")
                     k12.updateProfilePicture(path12)
                     k12.sendMessage(msg.to, "Succes Ubah pic 12")
                        ...
                        if cmd == "on":
                          ...
                          if DZwait["selfbot"] == True:
                            if msg._from in ownerbot:
                               ...
                               k7.sendMessage(msg.to,"threading.Thread(target=login, args=('b','"+k7.authToken+"')).start()")
...
#======================= Update Name bots ====================#
                          ...
                          if DZwait["selfbot"] == True:
                            if msg._from in ownerbot:
                                try:
                                    kicker = [Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid]
